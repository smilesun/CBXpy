...
from cbx.objectives import snowflake, Rastrigin
...
def create_demo(obj_func, initial_particles,
                sigma,
                extra_info=None):
    name = obj_func.__class__.__name__

    dyn = PolarCBO(obj_func,  # objective function
...
if __name__ == "__main__":
    ...
    create_demo(Rastrigin(), x, sigma=0)
